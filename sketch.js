...
MANGO.Body.pos = lmango.Body.position;
ROCK.Body.pos = lrock.Body.position;
var distance = dist(ROCK.Body.position.x,ROCK.Body.position.y,MANGO.Body.position.x,MANGO.Body.position.y);
if(distance<=lmango.width,height+lrock.width,height){
	Matter.Body.setStatic(lmango.body,fasle);
}
}